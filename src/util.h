...
/*
 * For some _f math function we can approximate by dirivative linearization.
 * function, function_prime, a,x.
 * 
 * This approximation can be faster than just calling the _f because it calls the
 * preprocessor.
 */
